...
mod tests {
    ...
    fn raw_value() {
        ...
        // let ice_creams = maybe_ice_cream(12).expect("error"); // the same as unwrap but wuth a custom error message
        // let ice_creams = maybe_ice_cream(12).unwrap_or(0); // the same as unwrap but with a default value if it's None
